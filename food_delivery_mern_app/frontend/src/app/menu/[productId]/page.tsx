...
const page = () => {
    ...
    return <>
        <div className='w-full bg-slate-200 flex justify-center items-center'>
            <div className='md:flex-row space-y-3 py-4 bg-white my-4 shadow flex flex-col lg:w-[600px] w-[350px] md:h-[220px] drop-shadow-md rounded-lg group cursor-pointer items-center justify-center'>
