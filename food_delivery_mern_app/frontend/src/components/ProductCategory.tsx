...
const ProductCategory = ({ price, name, category, image }: IAppProps) => {
    return (
        <div className=' bg-white shadow drop-shadow-md rounded-lg'>
            <div className='flex relative group cursor-pointer items-center justify-center min-w-[240px] px-3 flex-col flex-wrap'>
